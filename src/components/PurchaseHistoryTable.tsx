...
const PurchaseHistoryTable: React.FC = () => {
    ...
    const [selectedOrder, setSelectedOrder] = useState<{ orderId: string; productId: string } | null>(null);
    ...
    const tableHeader = (
        <TableHeader>
            <TableRow>
                ...
                <TableHead className="whitespace-nowrap text-center">리뷰작성</TableHead>
            </TableRow>
        </TableHeader>
    );
                    ...
                    {renderTable(
                        ordersForDate.map((order) => (
                            <TableRow key={`${order.order_id}-${order.product_id}`} className="hover:bg-gray-100">
                                ...
                                <TableCell className="whitespace-nowrap text-center">{order.order_quantity}</TableCell>
                                <TableCell className="whitespace-nowrap text-center">
