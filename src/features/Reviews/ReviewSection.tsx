...
const ReviewSection: React.FC<ReviewSectionProps> = ({ productId }) => {
  ...
  const {
    ...
    Database["public"]["Views"]["reviews_with_nickname"]["Row"][],
    Error
  >({
  ...
  const canUserReview =
    user && purchasedCount !== undefined && reviewCount !== undefined
      ? purchasedCount > reviewCount
      : false;
    ...
    <div className="mt-8">
      ...
      <div className="mt-8">
        {isAuthLoading || isPurchasedCountLoading || isReviewCountLoading ? (
          ...
          <p className="text-red-500">
            해당 상품 구매 여부를 판단하는 중 오류가 발생했습니다.
          </p>
        ) : (
          canUserReview && (
            <div>
